                ...
                <div className="container.xxl">
                    <div className="row">
                        <div className="col-3">
                            ...
                            <div>
                                <a href="tel:+1468990135" className="mt-4 d-block mb-2 black-link"> (469) 899-0154 </a>
                                <a href="mailto:skincity@gmail.com" className="mt-4 d-block mb-2 black-link"> skincity@gmail.com </a>
                            </div>
                            <div className="d-flex align-items-center gap-30 mt-4">
                                <a href="#" className="black-link"> <BsFacebook className="fs-4" /> </a>
                                <a href="#" className="black-link"> <BsInstagram className="fs-4" /> </a>
                                <a href="#" className="black-link"> <BsTwitter className="fs-4" /> </a>
                            </div> 
                        </div>
                        <div className="col-3">
                        ...
                        <div className="col-3">
                            ...
                            <div className="input-group"> 
                                <input type="text" class="form-control py-1" placeholder="Enter Your Email..." aria-label="Your Email Address" aria-describedby="basic-addon2"/>
                    ...
                    <div className="row">
                        <div className="col-12">
                            <p className="text-center mb-0">
                                &copy; {new Date().getFullYear()}; Skin City. All rights reserved. 
                            </p>
                        </div>
                    </div>
                </div>          
